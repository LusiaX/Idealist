 ...
 * @see RowProcessor
 * <p>
 * Created by Charles Cui<lfylccxm@hotmail.com> on 2021-05-19 00:59:46
 */
public class BasicRowProcessor implements RowProcessor {
     ...
     * @see idealist.dao.RowProcessor#toArray(ResultSet)
     */
    @Override
     ...
     * @throws SQLException if a database access error occurs
     * @see idealist.dao.RowProcessor#toBean(ResultSet, Class)
     * @see idealist.dao.BeanProcessor#toBean(ResultSet, Class)
     */
    @Override
     ...
     * @throws SQLException if a database access error occurs
     * @see idealist.dao.RowProcessor#toBeanList(ResultSet, Class)
     * @see idealist.dao.BeanProcessor#toBeanList(ResultSet, Class)
     */
    @Override
     ...
     * @throws SQLException if a database access error occurs
     * @see idealist.dao.RowProcessor#toMap(ResultSet)
     */
    @Override
