 ...
 * @since 1.4
 * <p>
 * Created by Charles Cui<lfylccxm@hotmail.com> on 2021-05-19 00:59:27
 */
public class AsyncJdbcAccessor extends AbstractJdbcAccessor {
     ...
     * @param executorService the {@code ExecutorService} instance used to run JDBC invocations concurrently.
     */
    public AsyncJdbcAccessor(ExecutorService executorService) {
     ...
     */
    @Deprecated
    public AsyncJdbcAccessor(DataSource ds, ExecutorService executorService) {
     ...
     */
    @Deprecated
    public AsyncJdbcAccessor(DataSource ds, boolean pmdKnownBroken, ExecutorService executorService) {
    ...
    public Future<int[]> batch(final Connection conn, final String sql, final Object[][] params) throws SQLException {
        return executorService.submit(new Callable<int[]>() {
            ...
            public int[] call() throws Exception {
                return jdbcAccessor.batch(conn, sql, params);
            }
    ...
    public Future<int[]> batch(final String sql, final Object[][] params) throws SQLException {
        return executorService.submit(new Callable<int[]>() {
            ...
            @Override
            public int[] call() throws Exception {
                return jdbcAccessor.batch(sql, params);
            }
    ...
    /**
     * Executes {@link JdbcAccessor#insert(String, ResultSetHandler)} asynchronously.
     *
     ...
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insert(String, ResultSetHandler)
     * @since 1.6
     */
    ...
    /**
     * Executes {@link JdbcAccessor#insert(String, ResultSetHandler, Object...)} asynchronously.
     *
     * @param <T>    Return type expected
     * @param sql    SQL insert statement to execute
     * @param rsh    {@link ResultSetHandler} for handling the results
     ...
     * @return {@link Future} that executes a query runner insert
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insert(String, ResultSetHandler, Object...)
     * @since 1.6
     */
    ...
    /**
     * Executes {@link JdbcAccessor#insert(Connection, String, ResultSetHandler)} asynchronously.
     *
     * @param <T>  Return type expected
     ...
     * @return {@link Future} that executes a query runner insert
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insert(Connection, String, ResultSetHandler)
     * @since 1.6
     */
    ...
    /**
     * Executes {@link JdbcAccessor#insert(Connection, String, ResultSetHandler, Object...)} asynchronously.
     *
     * @param <T>    Return type expected
     * @param conn   {@link Connection} to use to execute the SQL statement
     * @param sql    SQL insert statement to execute
     ...
     * @return {@link Future} that executes a query runner insert
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insert(Connection, String, ResultSetHandler, Object...)
     * @since 1.6
     */
    ...
    /**
     * {@link JdbcAccessor#insertBatch(String, ResultSetHandler, Object[][])} asynchronously.
     *
     * @param <T>    Return type expected
     * @param sql    SQL insert statement to execute
     * @param rsh    {@link ResultSetHandler} for handling the results
     ...
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insertBatch(String, ResultSetHandler, Object[][])
     * @since 1.6
     */
    ...
    /**
     * {@link JdbcAccessor#insertBatch(Connection, String, ResultSetHandler, Object[][])} asynchronously.
     *
     * @param <T>    Return type expected
     * @param conn   {@link Connection} to use to execute the SQL statement
     * @param sql    SQL insert statement to execute
     ...
     * @return {@link Future} that executes a query runner batch insert
     * @throws SQLException if a database access error occurs
     * @see JdbcAccessor#insertBatch(Connection, String, ResultSetHandler, Object[][])
     * @since 1.6
     */
